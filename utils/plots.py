...
def color_list():
    ...
    return [(0, 0, 255),(0,255,0)] # or BASE_ (8), CSS4_ (148), XKCD_ (949)
        ...
        if len(targets) > 0:
            ...
            for j, box in enumerate(boxes.T):
                ...
                if labels or conf[j] > 0.25:  # 0.25 conf thresh
                    ...
                    plot_one_box(box, mosaic, label=label, color=(0, 0, 255) , line_thickness=tl)
...
def plot_labels(labels, names=(), save_dir=Path(''), loggers=None):
    ...
    if 0 < len(names) < 30:
        ...
        ax[0].set_xticklabels(names, rotation=90, fontsize=1)
    else:
